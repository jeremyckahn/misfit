...
var copyMessage = blessed.text({
  bottom: 2,
  content: 'Will copy command to the clipboard!',
  style: {
    bg: '#ffff88',
    fg: '#000000'
  },
...
scriptTable.on('select', function (_, i) {
  ...
  var selectedScriptName = getHighlightedScript();
  var command = 'npm run ' + selectedScriptName;
